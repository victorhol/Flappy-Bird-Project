...
#2 sorterer populationen baseret på fitness score
    ...
    print(f"Bedste fitness: {best_fitness}, Gennemsnitlig fitness: {avg_fitness} | Best pipes: {best_pipes} | Avg pipes: {avg_pipes}")
...
def main():
    ...
    for run_idx in range(1, args.runs + 1):
        ...
        for gen in range(1, args.generations + 1):
            population, gen_row, per_net = run_generation(population)
